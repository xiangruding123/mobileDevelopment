...
(function() {
    ...
    function logLogin(signage){
        if(!isWeiXin()||signage){
			...
			scriptFile.setAttribute("src",'http://www.fenhongshop.com/wap/js/apiLink.js');
			document.getElementsByTagName("head")[0].appendChild(scriptFile);
			var scriptFile = document.createElement('script');
			scriptFile.setAttribute("type","text/javascript");
			scriptFile.setAttribute("src",'http://www.fenhongshop.com/wap/src/js/tmpl/login/checklogin.js');
			document.getElementsByTagName("head")[0].appendChild(scriptFile);
