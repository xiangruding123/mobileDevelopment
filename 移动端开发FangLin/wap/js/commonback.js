...
(function() {
    ...
    //微信分享自定义事件
    function wxShare(wx_title,wx_desc,wx_link,wx_img,friend_title,shop_id,shop_type){
                ...
                success: function(result) {
                    ...
                    wx.ready(function() {
                        ...
                        wx.onMenuShareAppMessage({
                            ...
                            success: function () {
                                shoper_commission_share(wx_title,wx_desc,wx_img,wx_link,_reason,"5",shop_id,shop_type);
                            }
                        });
                        //朋友圈
                        wx.onMenuShareTimeline({
                            ...
                            imgUrl: wx_img||'http://www.fenhongshop.com/wap/images/wap/logo.png',
                            success: function () {
                                shoper_commission_share(wx_title,wx_desc,wx_img,wx_link,_reason,"4",shop_id,shop_type);						    }
                        });
                        //QQ
                        wx.onMenuShareQQ({
                            title: wx_title, // 分享标题
                            ...
                            imgUrl: wx_img||'http://www.fenhongshop.com/wap/images/wap/logo.png' ,
                            success: function () {
                                shoper_commission_share(wx_title,wx_desc,wx_img,wx_link,_reason,"2",shop_id,shop_type);
                            }
                        });
                        //qzone
                        wx.onMenuShareQZone({
                            ...
                            imgUrl: wx_img||'http://www.fenhongshop.com/wap/images/wap/logo.png' ,
                            success: function () {
                                shoper_commission_share(wx_title,wx_desc,wx_img,wx_link,_reason,"6",shop_id,shop_type);
                            }
                        });
                    });
                }
    ...
    //分享
    function share(_title,_desc,_pic,_url,_reason,shop_id,shop_type){

        FL.wxShare(_title,_desc,_pic,_url,_reason,shop_id,shop_type);
        ...
        mobShare.config( {
            ...
            callback: function( plat, params ) {
                ...
                shoper_commission_share(_title,_desc,_pic,_url,_reason,sharetype,shop_id,shop_type);
            }
    ...
    function shoper_commission_share(_title,_desc,_pic,_url,_reason,sharetype,shop_id,shop_type){
